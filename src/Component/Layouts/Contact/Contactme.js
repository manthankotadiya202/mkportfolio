          ...
          <div className="row">
            <div className="col-md-6 col-sm-12">
              <div className="aboutus-details">
                <h2>Get In Touch</h2>
                <p>Reach out to me on below addresses.</p>
                ...
                <div className="col-md-6 col-sm-12">
                  <div className="about-datalist">
                    ...
                    <ul>
                      <li>
                        <i className="fa fa-mobile"></i>+1 647-870-6553
                      </li>
                      <li>
                        <i className="fa fa-envelope"></i>
                        manthankotadiya202@gmail.com
                      </li>
                      <li>
            ...
            <div className="col-md-6">
              <div className="form-box">
                ...
                <p>Fill below form to get in touch with me.</p>
